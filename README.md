...
# Live Demo
https://pegasus.vecitechnologies.net
...
```
 git clone https://github.com/codedsultan/pegasus.git
 cd pegasus-hrms
 composer install
 cp .env.example .env 
 ```
...
you can also [Buy Me a Coffee ☕](https://www.buymeacoffee.com/codesultan) :)


# Contact
If your organization needs help with implementing this system or any other system, or needs a custom system built for you, 
please contact me at [codesultan369@gmail.com](mailto:codesultan369@gmail.com)
